...
## Index by functional area

| Ken area | Weight | Status | Primary documents |
|----------|--------|--------|-------------------|
| **Technology & Product** | 10% | PARTIAL | [ORALABLE_FTS_36MO.md](./ORALABLE_FTS_36MO.md) · [ORALABLE_SYSTEM_ARCHITECTURE.md](../ORALABLE_SYSTEM_ARCHITECTURE.md) · `oralable_nrf/docs/DEVELOPMENT.md` · `oralable_swift/docs/MOBILE_APP_FLOWS.md` |
| **Market & Positioning** | 5% | PARTIAL | [MARKET_SIZING.md](./MARKET_SIZING.md) (~4.1M / ~1.4M US sketch) · landscape doc · **GAP:** primary cites + IE/UK cut |
| **GTM & Sales** | 10% | PARTIAL | [GTM_ONE_PAGE.md](./GTM_ONE_PAGE.md) · [PITCH_DECK_KEN.md](./PITCH_DECK_KEN.md) (distill) · **GAP:** full CAC model |
| **User Traction & Revenue** | 10% | GAP | **GAP:** lifecycle + MRR model · pilot will supply first usage evidence |
| **Financials** | 10% | PARTIAL | [FINANCIALS_CASH_SNAPSHOT.md](./FINANCIALS_CASH_SNAPSHOT.md) · [FUNDING_POINT_B_AND_CAP_TABLE.md](./FUNDING_POINT_B_AND_CAP_TABLE.md) (Point B €180k) · [COST_AND_TIMELINE.md](./COST_AND_TIMELINE.md) · **GAP:** F&F valuation, CLN terms, runway monthlies, statutory pack in git |
| **Team & Governance** | 10% | PARTIAL | **[CURRENT_GOVERNANCE_STATUS.md](./CURRENT_GOVERNANCE_STATUS.md)** · [KEN_PRESEED_STRUCTURE_EVAL.md](./KEN_PRESEED_STRUCTURE_EVAL.md) (Ken Pre-Seed memo = proposal) · [JAC_CORPORATE_STRUCTURE_AND_GOVERNANCE.md](./JAC_CORPORATE_STRUCTURE_AND_GOVERNANCE.md) · [MEETING_BRIEF_KEN_NIGEL_2026-07-22.md](./MEETING_BRIEF_KEN_NIGEL_2026-07-22.md) · [FUNDING_POINT_B_AND_CAP_TABLE.md](./FUNDING_POINT_B_AND_CAP_TABLE.md) · **GAP:** complete Conor purchase · Strand Two · CRO cite · CEO contract · option scheme |
| **Legal, IP & Corp** | 10% | PARTIAL | [IP_PORTFOLIO_STATUS.md](./IP_PORTFOLIO_STATUS.md) · [IP_EVAL_AND_LANDSCAPE.md](./IP_EVAL_AND_LANDSCAPE.md) · **EP 4 333 691 B1** · IE/UK steps taken · **GAP:** sign IE AoA · UP by 8 Aug · assign provisional · FTO · Lisa Curley deed |
| **Risk, Regulation & Compliance** | 15% | PARTIAL | [REGULATORY_TIMELINE.md](./REGULATORY_TIMELINE.md) · `RegulatoryPackageBuilder` (app) · **GAP:** product liability cert |
| **International Readiness** | 5% | GAP | GTM international outline in GTM one-pager · **GAP:** Android build |
| **Data Room & Investment Docs** | 5% | PARTIAL | This index · [PITCH_DECK_KEN.md](./PITCH_DECK_KEN.md) · `docs/upload/` pack · **GAP:** investor-final deck polish |
| **Voice** | 10% | GAP | **Pending:** founder voice session (Balance Points) |

---

## Pilot program (operating evidence)
...
## Repository map (technology diligence)

| Repo | Role | Hub |
|------|------|-----|
| `oralable_nrf` | Firmware pcb00003, GATT, OTA | `docs/README.md` |
| `oralable_swift` | iOS consumer + dentist apps | `docs/MOBILE_APP_FLOWS.md` |
| `OralableCore` | BLE parsing, algorithms, CloudKit handshake | Swift package |
| `cursor_oralable` | Python validation, clinical protocols, this data room | `docs/README.md` |
...
## Priority completion order (Ken CRITICAL)

1. ✅ Data room index (this file)
2. ✅ FTS 36-month draft
3. ✅ Regulatory timeline one-pager
4. ✅ GTM one-pager
5. ✅ Ed/Pedro pilot protocol
6. ⏳ Execute pilot → update `CLINICAL_VALIDATION.md` + traction appendix
