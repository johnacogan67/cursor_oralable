...
| Ken / Point A | [PITCH_DECK_KEN.md](./PITCH_DECK_KEN.md) · [README.md](./README.md) |
...
JAC Dental Solutions Limited (CRO 697987), formerly associated with Byteexplain share-issue history, is the Irish operating company behind Oralable — a temple-worn optical wearable for overnight vitals and, later, jaw-load / sleep-bruxism metrics. As of July 2026 the Register of Members shows **11,901** ordinary shares at €0.01: John Cogan **~63%**, Conor Meaney (register distill: Meany) **~21%**, and named angels **~16%**. Special resolutions under the Companies Act 2014 require a **75%** majority, so the ~21% block is a constitutional funding constraint, not merely optics. **As of 19–23 Jul 2026 an Amstrow Cosec–brokered purchase of Conor’s shares is in active negotiation** (register unchanged until completion). Cash Point A is thin (**€1,293** closing 17 Jul 2026) and founder-loan funded (~€63.5k director loans in-period); near-term capital is Ken/BalancePoints **Point B €180k by 31 Oct 2026** (€50k F&F equity + €100k EI PSSF CLN + €30k HPSU grant). Board: John Cogan (majority shareholder; currently operating as founder-CEO) and **Nigel Woods (Amstrow) as Independent Director**; Amstrow Cosec (Collette Brown) is actively administering corporate secretarial correspondence. **Proposed** operating model (not yet board-approved or contracted): Ken Kinsella as **CEO** (fundraising and commercial execution), John as **Executive Chairman / Founder** (product, clinical, IP), Nigel with a fuller **Company Secretary + Amstrow finance** remit (registers, bookkeeping, R&D tax reclaim). Neither Ken nor Nigel holds register equity today; option/success equity remains open with Point B instruments. IP, product, and regulatory detail live in the Oralable data room; this brief covers entity, register, and who does what.

---

## 1. Entity synopsis

These notes update an older NotebookLM vault synopsis that mixed P&amp;L, counsel transition, MAXM86161 hardware, market/patent analysis, and EEA compliance. That technical and market material still belongs in product / IP docs; **this file is the corporate and ownership layer**.
...
**Why this shape:** Investors and EI HPSU typically want the **founder-scientist visible** and the **independent director not also day-to-day CEO**. Ken CEO + John Executive Chairman + Nigel Independent Director / CoSec-finance keeps register control with John while professionalising raise and finance ops.
...
| Status | **External strategic advisor** (Point A → Point B) | **CEO** (contracting / hire) — **not yet appointed** |
...
**Interface rule (target model):** Ken as CEO may lead the investor process and day-to-day commercial ops; John remains Executive Chairman and majority owner; Ken does **not** cast John’s shareholder votes and is **not** a substitute for the board.
...
| Gen2 Kaga sample lot | **€3,735** | [GEN2_COGS_KAGA_QUOTE.md](./GEN2_COGS_KAGA_QUOTE.md) |
...
Background for leverage / context — settlement now runs through **Amstrow Cosec written offers**, not informal only:
...
| Ken pitch distill | [PITCH_DECK_KEN.md](./PITCH_DECK_KEN.md) |
