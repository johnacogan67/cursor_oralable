...
**Predicate strategy:** 510(k) substantial equivalence to existing **home bruxism / sleep activity monitors** (often EMG-based); differentiate on **optical IR-DC at masseter** with concordance data.
...
Protocol: [PILOT_PROTOCOL_ED_PEDRO.md](./PILOT_PROTOCOL_ED_PEDRO.md)
