...
**Related:** Paper A audit [PAPER_A_VALIDATION_AND_FUTURE_WORK.md](./PAPER_A_VALIDATION_AND_FUTURE_WORK.md) · Nabavi [COLLAB_NABAVI_MCGILL.md](./COLLAB_NABAVI_MCGILL.md) · kit [ORALABLE_RESEARCH_KIT.md](./ORALABLE_RESEARCH_KIT.md) · feasibility [PAPER_A_FEASIBILITY_PROTOCOL.md](./PAPER_A_FEASIBILITY_PROTOCOL.md) · ANR [ANR_M40_CONCORDANCE.md](./ANR_M40_CONCORDANCE.md) · corroboration [SENSOR_CORROBORATION.md](./SENSOR_CORROBORATION.md) · parity [MAC_PHONE_ALGORITHM_PARITY.md](./MAC_PHONE_ALGORITHM_PARITY.md) · Pedro [PEDRO_STATUS_UPDATE_2026-08.md](./PEDRO_STATUS_UPDATE_2026-08.md)
...
2. Pedro locks Beacon ethics + Arm P CRF ([PAPER_A_FEASIBILITY_PROTOCOL](./PAPER_A_FEASIBILITY_PROTOCOL.md) §7).  
...
1. [ANR_M40_CONCORDANCE.md](./ANR_M40_CONCORDANCE.md) — BLE Design Guide + ANR iPhone app bookmarks; nRF Connect optional for ANR only.  
...
4. [ACUPEBBLE_VS_ORALABLE_ANR.md](./ACUPEBBLE_VS_ORALABLE_ANR.md) — Pedro AcuPebble (HSAT/AHI) vs Oralable vs ANR; Oralable ≠ AHI clone.
...
1. Pack bump **1.1.62 → 1.1.63**; [SENSOR_CORROBORATION.md](./SENSOR_CORROBORATION.md) bookmark.  
