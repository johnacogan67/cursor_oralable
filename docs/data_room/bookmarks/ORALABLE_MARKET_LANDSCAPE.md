...
Canonical map: `cursor_oralable/docs/PRODUCT_ROADMAP.md` · cost/timeline: `cursor_oralable/docs/data_room/governance/COST_AND_TIMELINE.md` · IP stages: `cursor_oralable/docs/IP_NORTH_STAR.md` (Stage A wearable → Stage B medical).
...
Li et al., *Aust Dent J* 2024;69(Suppl 1):S53–S62 ([doi:10.1111/adj.13057](https://doi.org/10.1111/adj.13057)). Full distill: `cursor_oralable/docs/data_room/bookmarks/LITERATURE_AND_PRIOR_ART.md`.
...
Ceramic **finger ring** (company: 2.4 mm × 8 mm) — jewelry form like **Oura**, not a temple clip. Bookmark: `cursor_oralable/docs/data_room/bookmarks/HAPPY_RING.md`.
...
- [Happy Ring / Happy Sleep](https://www.happysleep.com/tech) · [K240236](https://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfpmn/pmn.cfm?ID=K240236) · [K242224](https://www.accessdata.fda.gov/cdrh_docs/pdf24/K242224.pdf) · bookmark `cursor_oralable/docs/data_room/bookmarks/HAPPY_RING.md`
