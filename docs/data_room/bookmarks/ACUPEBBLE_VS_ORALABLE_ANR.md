...
2. **Oralable** — same-night or 1–2 h temple vitals + later brux/jaw-load alongside MAD ([MAYORAL_METHOD_ORALABLE_VALIDATION.md](../clinical/MAYORAL_METHOD_ORALABLE_VALIDATION.md)).  
