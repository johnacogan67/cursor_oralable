...
13. AcuPebble / Acurable HSAT landscape — nest with Arm P; Oralable ≠ AHI ([ACUPEBBLE_VS_ORALABLE_ANR.md](../bookmarks/ACUPEBBLE_VS_ORALABLE_ANR.md)).
16. Happy Ring / Happy Health — Oura-like finger HSAT (K240236 monitoring; K242224 hAHI SaMD); nest class, not Oralable substitute ([HAPPY_RING.md](../bookmarks/HAPPY_RING.md)).  
