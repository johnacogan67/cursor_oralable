...
**Build date:** July 2026 · **Role:** **Rollback only** (current target = **1.0.84**) · Ed/Pedro = **patient app only**

Includes **1.0.65** energy, LED, and charge fixes **plus** BLE RSSI and reconnect improvements.

> **Superseded:** flash **1.0.84**. Prior archives [1.0.82](./FIRMWARE_1.0.82_FLASH.md) · [1.0.70](./FIRMWARE_1.0.70_FLASH.md). Keep 1.0.66 binaries for recovery only.
...
- [GEN1_GEN2_TRACKING.md](../GEN1_GEN2_TRACKING.md) · current target **1.0.84** · prior: [FIRMWARE_1.0.82_FLASH.md](./FIRMWARE_1.0.82_FLASH.md)
