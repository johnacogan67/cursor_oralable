...
**Related:** [ED_PEDRO_AGENDA_2026-06-07.md](./ED_PEDRO_AGENDA_2026-06-07.md) (names “Mayoral Method titration ground-truth”) · [ED_PEDRO_QUICK_START.md](./ED_PEDRO_QUICK_START.md) · [ED_PEDRO_SB_FEP_DRAFT_PAPER.md](./ED_PEDRO_SB_FEP_DRAFT_PAPER.md) (Owens & Mayoral 2026 SB × FEP — published) · [MEASUREMENT_CONSTRUCT_MAP.md](./MEASUREMENT_CONSTRUCT_MAP.md) · [PAPER_A_FEASIBILITY_PROTOCOL.md](./PAPER_A_FEASIBILITY_PROTOCOL.md) (feasibility n≈5 · Arm P 1–2 h) · [ACUPEBBLE_VS_ORALABLE_ANR.md](./ACUPEBBLE_VS_ORALABLE_ANR.md) · [OVERNIGHT_NIGHT_REPORT.md](../OVERNIGHT_NIGHT_REPORT.md) · [PAPER_A_IEEE_TEMPORALIS_OMG_DRAFT.md](./PAPER_A_IEEE_TEMPORALIS_OMG_DRAFT.md)
...
**Internal agenda language:** position Oralable vs acoustic-only tools using **“Mayoral Method titration ground-truth framing”** ([ED_PEDRO_AGENDA](./ED_PEDRO_AGENDA_2026-06-07.md)).
