...
*Related:* [CEO_JOB_DESCRIPTION.md](./CEO_JOB_DESCRIPTION.md) · [PITCH_DECK_KEN.md](./PITCH_DECK_KEN.md) (BalancePoints working session — separate) · [CURRENT_GOVERNANCE_STATUS.md](./CURRENT_GOVERNANCE_STATUS.md)
