...
| [upload/03_GITHUB_REPOS_OVERVIEW.txt](./archive/upload_2026-06/03_GITHUB_REPOS_OVERVIEW.txt) | **Deprecated** four-repo snapshot | Current truth |
...
**Mac → phone rule:** prove algorithms in `cursor_oralable`, then port to `OralableCore` + the app. Default: change the phone to match Mac. See [ALGORITHM_ARCHITECTURE.md](./ALGORITHM_ARCHITECTURE.md) and [MAC_PHONE_ALGORITHM_PARITY.md](./data_room/bookmarks/MAC_PHONE_ALGORITHM_PARITY.md).
...
| `hardware` | PCB, BOM, Gen1/Gen2, charge, Altium | `oralable_nrf` · `cursor_oralable` | [PRODUCT_ROADMAP.md](./PRODUCT_ROADMAP.md) · [HW_ENGINEER_ALTIUM_BRIEF.md](./data_room/hardware/HW_ENGINEER_ALTIUM_BRIEF.md) |
| `ios-patient` | Patient app, vitals UX, Dual A session | `oralable_swift` · `OralableCore` | `oralable_swift/docs/MOBILE_APP_FLOWS.md` |
| `ios-dentist` | Dentist app, CloudKit (dark / Phase 1+) | `oralable_swift` · `OralableCore` | `MOBILE_APP_FLOWS.md` §5–7 · [APPS_AND_REVENUE_EVAL.md](./data_room/governance/APPS_AND_REVENUE_EVAL.md) |
...
| `clinical` | Protocol A/B, Dual A, ANR, Paper A | `cursor_oralable` | [MEASUREMENT_CONSTRUCT_MAP.md](./data_room/clinical/MEASUREMENT_CONSTRUCT_MAP.md) · [TEMPORALIS_COLLECTION_PROTOCOL.md](./TEMPORALIS_COLLECTION_PROTOCOL.md) |
| `research-kit` | Ed/Pedro kits, flash, handoff | `cursor_oralable` | [ORALABLE_RESEARCH_KIT.md](./data_room/clinical/ORALABLE_RESEARCH_KIT.md) |
| `data-room` | Investor index, pitches, Ken areas | `cursor_oralable` | [data_room/README.md](./data_room/README.md) |
| `ip` | Patents, landscape, north star | `cursor_oralable` | [IP_NORTH_STAR.md](./IP_NORTH_STAR.md) · [IP_PORTFOLIO_STATUS.md](./data_room/governance/IP_PORTFOLIO_STATUS.md) |
| `regulatory` | Wellness → 510(k) / CE | `cursor_oralable` | [REGULATORY_TIMELINE.md](./data_room/governance/REGULATORY_TIMELINE.md) |
| `gtm` | Market, GTM, competitors | `cursor_oralable` | [GTM_ONE_PAGE.md](./data_room/governance/GTM_ONE_PAGE.md) · [ORALABLE_MARKET_LANDSCAPE.md](./data_room/bookmarks/ORALABLE_MARKET_LANDSCAPE.md) |
| `governance` | Cap table, Ken/Nigel, funding | `cursor_oralable` | [CURRENT_GOVERNANCE_STATUS.md](./data_room/governance/CURRENT_GOVERNANCE_STATUS.md) |
| `brand` | Figures, look, Orwell voice | `cursor_oralable` | [FIGURES.md](./FIGURES.md) · [VISUAL_AND_VOICE_DIRECTION.md](./data_room/brand/VISUAL_AND_VOICE_DIRECTION.md) |
...
- **Docs:** `oralable_nrf/docs/DEVELOPMENT.md` · `OTA_DEVICE_MANAGER.md` · target FW **1.0.84** (`app/VERSION`) · prior OTA [FIRMWARE_1.0.82_FLASH.md](./data_room/firmware/FIRMWARE_1.0.82_FLASH.md)
...
- **Quotes:** `docs/data_room/hardware/GEN1_COGS_KAGA_QUOTE.md` · `GEN2_COGS_KAGA_QUOTE.md` · `HW_ENGINEER_ALTIUM_BRIEF.md`
...
- **Docs:** `MOBILE_APP_FLOWS.md` §5–7 · [APPS_AND_REVENUE_EVAL.md](./data_room/governance/APPS_AND_REVENUE_EVAL.md)
...
- **Docs:** [ALGORITHM_ARCHITECTURE.md](./ALGORITHM_ARCHITECTURE.md) · [IR_DC_ADC_FORMAT.md](./IR_DC_ADC_FORMAT.md) · [MAC_PHONE_ALGORITHM_PARITY.md](./data_room/bookmarks/MAC_PHONE_ALGORITHM_PARITY.md) · [MEASUREMENT_CONSTRUCT_MAP.md](./data_room/clinical/MEASUREMENT_CONSTRUCT_MAP.md) (MAM labels vs Dual A / AcuPebble / PSG)
...
- **Docs:** [OVERNIGHT_NIGHT_REPORT.md](./OVERNIGHT_NIGHT_REPORT.md) · [MEASUREMENT_CONSTRUCT_MAP.md](./data_room/clinical/MEASUREMENT_CONSTRUCT_MAP.md) (state names vs EMG / AHI)
...
- **Docs:** [ORALABLE_RESEARCH_KIT.md](./data_room/clinical/ORALABLE_RESEARCH_KIT.md) · [ED_PEDRO_QUICK_START.md](./data_room/clinical/ED_PEDRO_QUICK_START.md) · [PAPER_A_DATA_HANDOFF_SOP.md](./data_room/clinical/PAPER_A_DATA_HANDOFF_SOP.md) · [PEDRO_STATUS_UPDATE_2026-08.md](./data_room/clinical/PEDRO_STATUS_UPDATE_2026-08.md)
- **Flash:** [FIRMWARE_1.0.84_FLASH.md](./data_room/firmware/FIRMWARE_1.0.84_FLASH.md) · rollback [FIRMWARE_ROLLBACK.md](./data_room/firmware/FIRMWARE_ROLLBACK.md)
...
- **Docs:** [IP_NORTH_STAR.md](./IP_NORTH_STAR.md) · [IP_PORTFOLIO_STATUS.md](./data_room/governance/IP_PORTFOLIO_STATUS.md) · [IP_EVAL_AND_LANDSCAPE.md](./data_room/governance/IP_EVAL_AND_LANDSCAPE.md)

### `regulatory`

Wellness wording now. Stage B later. No FDA/CE claims in code comments or Core docs.

- **Docs:** [REGULATORY_TIMELINE.md](./data_room/governance/REGULATORY_TIMELINE.md) · architecture §2 product truth

### `gtm`

Market sketch, GTM one-pager, competitor landscape.

- **Docs:** [GTM_ONE_PAGE.md](./data_room/governance/GTM_ONE_PAGE.md) · [MARKET_SIZING.md](./data_room/governance/MARKET_SIZING.md) · [ORALABLE_MARKET_LANDSCAPE.md](./data_room/bookmarks/ORALABLE_MARKET_LANDSCAPE.md) · [DIANYX_FDA_AND_SMART_OAT_LANDSCAPE.md](./data_room/bookmarks/DIANYX_FDA_AND_SMART_OAT_LANDSCAPE.md)

### `governance`

Living snapshot first. Cap table and Point B sit in data room; statutory packs sit outside git.

- **Docs:** [CURRENT_GOVERNANCE_STATUS.md](./data_room/governance/CURRENT_GOVERNANCE_STATUS.md) · [JAC_CORPORATE_STRUCTURE_AND_GOVERNANCE.md](./data_room/governance/JAC_CORPORATE_STRUCTURE_AND_GOVERNANCE.md) · [FUNDING_POINT_B_AND_CAP_TABLE.md](./data_room/governance/FUNDING_POINT_B_AND_CAP_TABLE.md)

### `brand`

Figure IDs stay locked. Prose is Orwell. Look is locked in the visual note.

- **Docs:** [FIGURES.md](./FIGURES.md) · [VISUAL_AND_VOICE_DIRECTION.md](./data_room/brand/VISUAL_AND_VOICE_DIRECTION.md) · `docs/data_room/brand/`
...
**Edit Cursor rules in `cursor_oralable/.cursor/rules/` only**, then run `scripts/sync_cursor_rules.sh` to copy into the sibling repos (keeps MD5 drift down).
